...
from model.seg_utils import MaxUnpooling2D,MaxPoolingWithArgmax2D
...
def SegNet(nClasses, input_height, input_width):
    ...
    # x = vgg16(include_top=False, weights='imagenet',
    #      input_tensor=x, input_shape=None, pooling=None, classes=1000)
